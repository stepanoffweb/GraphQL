...
class MoviesForm extends React.Component {
  ...
  handleSave = () => {
    ...
    id ?
      updateMovie({id, name, genre, rate: Number(rate), isWatched: Boolean(isWatched), directorId}) :
      addMovie({name, genre, rate: Number(rate), isWatched: Boolean(isWatched), directorId})
    onClose();
  };
